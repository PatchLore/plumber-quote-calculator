...
export function createBrowserSupabaseClient(options = DEFAULT_BROWSER_SUPABASE_OPTIONS) {
    if (typeof window === 'undefined') {
        return null;
    }
    const supabaseUrl = options.supabaseUrl || DEFAULT_BROWSER_SUPABASE_OPTIONS.supabaseUrl;
    const supabaseAnonKey = options.supabaseAnonKey || DEFAULT_BROWSER_SUPABASE_OPTIONS.supabaseAnonKey;
...
export function createServiceSupabaseClient(options = DEFAULT_SERVER_SUPABASE_OPTIONS) {
