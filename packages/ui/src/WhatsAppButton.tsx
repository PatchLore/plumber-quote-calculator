...
export default function WhatsAppButton({ phoneNumber }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex items-center justify-center w-12 h-12 rounded-full bg-blue-600 text-white shadow-lg hover:bg-blue-700 hover:scale-105 transition-all"
    >
      <svg
