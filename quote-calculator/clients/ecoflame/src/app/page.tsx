const clientName = process.env.NEXT_PUBLIC_CLIENT_NAME || "EcoFlame Heating & Plumbing";
const clientEmail = process.env.NEXT_PUBLIC_CLIENT_EMAIL || "hello@ecoflame.co.uk";

const highlights = [
  "Gas Safe boiler installs engineered for energy efficiency",
  "Rapid-response emergency repairs across London & Surrey",
  "Service plans with automated QuoteFlow reminders",
  "Supabase CRM integration for every lead",
];
