...
export default function ServicesPage() {
  return (
    <main className="mx-auto max-w-5xl space-y-16 px-6 py-16 text-slate-900">
      ...
      <section className="rounded-2xl bg-slate-900 px-6 py-10 text-white">
        ...
        <p className="mt-3 max-w-3xl text-slate-300">
          {siteConfig.title} offers tailored retainers, one-off projects, and urgent support to keep your digital
          experience consistent. Every engagement includes clear communication, fast turnaround, and dependable quality.
        </p>
