const clientName = process.env.NEXT_PUBLIC_CLIENT_NAME || "Your Trade Business";
const clientEmail = process.env.NEXT_PUBLIC_CLIENT_EMAIL || "contact@example.com";

const highlights = [
  "Instant QuoteFlow calculator",
