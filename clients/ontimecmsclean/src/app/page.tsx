...
export default function Home() {
  return (
    <main className="bg-slate-950/5 overflow-hidden">
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 py-28 text-white">
        ...
        <div className="mx-auto flex max-w-screen-xl flex-col items-center gap-6 px-4 text-center sm:px-6 md:items-start md:text-left">
          ...
          <div className="mt-4 space-y-2 text-left text-sm text-blue-200 md:mt-6 md:space-y-3 md:text-base">
            <p>✔ Gas Safe Registered</p>
            <p>✔ Local Expert</p>
            <p>✔ Fast Response</p>
            <p>✔ Fully Insured</p>
          </div>
          <div className="mt-10 flex flex-col items-center space-y-3 md:flex-row md:space-y-0 md:space-x-4">
            <a
              href="/contact"
              className="w-full rounded-full bg-blue-600 px-8 py-4 text-center text-sm font-semibold text-white shadow-xl shadow-blue-900/40 transition hover:bg-blue-500 md:w-auto md:text-base"
            >
              📞 Contact {siteConfig.title}
            </a>
            <a
              href={`https://wa.me/${whatsappPhone}`}
              className="w-full rounded-full border border-white/20 bg-white/10 px-8 py-4 text-center text-sm font-semibold text-blue-200 backdrop-blur-md transition hover:bg-white/20 md:w-auto md:text-base"
            >
      ...
      <section className="bg-slate-900 py-20 text-white">
        <div className="mx-auto max-w-screen-lg px-4 text-center sm:px-6">
