...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 left-5 z-50 flex items-center gap-2 bg-green-500 text-white px-4 py-3 rounded-full shadow-lg hover:bg-green-600 transition-all sm:px-5 sm:py-3"
    >
      <svg
      ...
      <span className="hidden md:inline font-medium">Message Us</span>
    </a>
  )
}
